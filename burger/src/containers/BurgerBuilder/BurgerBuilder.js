...
class BurgerBuilder extends Component {
    ...
    componentDidMount () {
        ...
        axios.get('https://react-my-burger-56506.firebaseio.com/ingredients.json')
            .then(response => {
    ...
    render () {
        ...
        {/* Fix for modal shouldComponentUpdate functionality*/}
                <Modal show={this.state.purchasing} loading={this.state.loading} modalClosed={this.purchaseCancelHandler}>
                    {orderSummary}
                </Modal>
                {burger}
            </Aux>
